...
const Dishes = () => {
  return (
    ...
    //       <h3 className="text-3xl font-bold  mb-4 text-center text-brightColor">
    ...
    //           Epices: Aromates ex: basilic Légumes biologiques si possible Cours
    //           <br />
    ...
    //           cours offert
    //           <br /> Choix parmi les différents potager : pour tisanes et
    //           infusions, pour légumes perpétuels
    //           <br /> pour les aromatiques, pour les enfants, pour barbecue
    //         </p>
    //       </div>
    //       <div className="right-side">
    //         <p className="text-gray-700 mb-4">
    //           Conseil sur la culture des légumes selon les goûts, saisons, son
    //           <br />
    //           métabolisme, sa cuisinecuisine à plusieurs choix parmi la
    //           française
    //           <br /> belge, méditerranéenne, africain Centre - Est.2-3h
    //           Explications, conseils sur
    //           <br /> les fleurs et arbres de saisons ou de toute l'année et
    //           exotiques. cours offert
    //         </p>
    //         <p className="text-gray-700 mb-4 ">
    //           TARIF: 38 à 58 € par heure de cours particuliers ou travaux à
    //           domicile. Cuisinière diplômée
    //           <br /> à Bruxelles Ancienne étudiante en Biochimie Ancienne
    //           éleveuse de lapins
    //           <br /> Hobbie-vente Maraîchage potager et jardinier; Cours
    //         </p>
    //       </div>
    //     </div>
    //   </div>
